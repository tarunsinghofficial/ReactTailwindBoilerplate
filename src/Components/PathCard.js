...
const PathCard = ({ bgImage, title, description, tag, isSelected, onSelect }) => {
    return (
        <div className={`relative w-auto h-auto rounded-md hover:cursor-pointer hover:shadow-md p-5 lg:p-10 border-2 border-gray-200 hover:border-[#f6c855] bg-white ${isSelected ? 'border-2 border-yellow-400 shadow-md' : 'hover:border-[#f6c855] hover:shadow-md'}`} onClick={onSelect}>
